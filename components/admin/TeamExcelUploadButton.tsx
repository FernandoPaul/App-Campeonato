...
export default function TeamExcelUploadButton() {
    ...
    const [state, formAction, isPending] = useActionState(uploadTeamsFromExcel, undefined)
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
                        ...
                        <div className="p-6">
                            <p className="text-sm text-zinc-400 mb-6">
                                Descarga la plantilla, rellénala con los datos de tus equipos y súbela aquí para crearlos todos de una vez.
                            </p>

                            <div className="mb-6 flex justify-center">
                                <a
                                    href="/templates/plantilla-equipos.xlsx"
                                    download
