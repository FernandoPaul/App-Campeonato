...
export default function ExcelUploadButton() {
  ...
  const [state, formAction, isPending] = useActionState(uploadMatchesFromExcel, undefined)
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-sm text-zinc-400 mb-6">
                Descarga la plantilla, llénala con los datos de tus partidos y súbela aquí para crearlos todos de una vez.
              </p>

              <div className="mb-6 flex justify-center">
                <a 
                  href="/templates/plantilla-partidos.xlsx" 
                  download
                ...
                {state?.success && (
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4">
                    ...
                    {state.errors && state.errors.length > 0 && (
                      <ul className="text-xs text-zinc-400 space-y-1 mt-2 list-disc list-inside">
