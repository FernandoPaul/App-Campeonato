    ...
    <div className="flex h-screen bg-zinc-950 text-zinc-100">
      ...
      <aside className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col">
        ...
        <nav className="flex-1 py-4 flex flex-col gap-1 px-3">
          <Link href="/admin/dashboard" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors">
            <LayoutDashboard className="w-5 h-5 mr-3 text-zinc-400" />
            Dashboard
          </Link>
          <Link href="/admin/categorias" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors">
            <Trophy className="w-5 h-5 mr-3 text-zinc-400" />
            Categorías
          </Link>
          <Link href="/admin/equipos" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors">
            <Users className="w-5 h-5 mr-3 text-zinc-400" />
            Equipos
          </Link>
          <Link href="/admin/partidos" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors">
