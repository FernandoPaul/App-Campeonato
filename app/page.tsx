...
export const metadata = {
  ...
  description: "Portal oficial del campeonato. Consulta categorías, partidos, clasificaciones y resultados.",
}
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-lg text-zinc-400 max-w-xl mx-auto">
            Consulta categorías, partidos programados, resultados y clasificaciones en tiempo real.
          </p>
        </div>
      </header>
        ...
        <section>
          ...
          {categories.length === 0 && (
            <div className="py-16 text-center border border-dashed border-zinc-800 rounded-2xl">
              ...
              <h3 className="text-lg font-medium text-white mb-1">No hay categorías publicadas</h3>
              <p className="text-zinc-500 text-sm">Las categorías aparecerán aquí cuando se publiquen desde el panel de administración.</p>
            </div>
          )}
        </section>
